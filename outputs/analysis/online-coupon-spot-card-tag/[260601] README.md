...
| # | 파일 | 한 줄 요약 | 우선순위 |
|---|------|-----------|---------|
| 01 | [spot-card-ctr.md](./[260601] 01-spot-card-ctr.md) | 스팟 카드 CTR — 태그 노출 전/후, 쿠폰 보유 vs 비보유 비교 (핵심) | 높음 |
| 02 | [coupon-spot-coverage.md](./[260601] 02-coupon-spot-coverage.md) | 태그 노출 대상 스팟 규모·분포·추이 | 중간 |
| 03 | [tag-conversion-funnel.md](./[260601] 03-tag-conversion-funnel.md) | 태그 → 상세 진입 → 쿠폰 적용 결제 퍼널 + 카니발리제이션 | 중간 |
| 04 | [beauty-cashback-benchmark.md](./[260601] 04-beauty-cashback-benchmark.md) | 뷰티 캐시백 태그를 벤치마크로 기대 증분 추정 | 낮음(참고) |
